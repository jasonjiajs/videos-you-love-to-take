...
15.773A: Hands-On Deep Learning Project Proposal, Spring 2024

Project Title: What videos do you love to take? - Personal video classification with deep learning

Team Members: 
Jason Jia (jasonjia@mit.edu)
Maria Besedovskaya (m_besed@mit.edu)
Maxime Wolf (maximew@mit.edu)
Minnie Arunaramwong (atistarn@mit.edu) 
Link to code files:
The link to the GitHub repo is: https://github.com/jasonjiajs/videos-you-love-to-take 
The notebook that runs inference can be found at: https://github.com/jasonjiajs/videos-you-love-to-take/blob/main/code/predict_label.ipynb
The notebook that trains the model can be found at: https://github.com/jasonjiajs/videos-you-love-to-take/blob/main/code/model.ipynb 
